...
class LibraryAuthor(models.Model):
    ...
    books = fields.Text(string="Libros")
...
{
    'name': "libreria",
    'summary': 'Módulo para gestionar la librería',
    'author': "Adrián",
    'category': 'Tools',
    'version': '0.1',
    'depends': ['base'],
...
Aquí vemos que funciona el modulo.

11 - Vemos que en el menú nos aparece el modulo Biblioteca. Pinchamos ahí.
![Imagen 5](./imagenes/imagen5.png)

12 - Ahora nos sale para poder crear un libro nuevo y un autor nuevo. Pinchamos primero en autores.
![Imagen 6](./imagenes/imagen6.png)

13 - Y aquí podemos crear el autor
![Imagen 7](./imagenes/imagen7.png)

14 - Y aquí podemos crear el libro
